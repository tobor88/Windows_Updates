...
- **Install-FileZilla** (*Install or update FileZilla after verifying checksum*)
- **Install-GitForWindows** (*Install or update Git for Windows after verifying checksum*)
- **Install-KeePass** (*Install or update KeePass after verifying checksum*)
- **Install-NotepadPlusPlus** (*Install or update Notepad++ after verifying checksum*)
- **Install-PowerShellCore** (*Install or update PowerShell Core after verifying checksum*)
- **Install-SccmAgent.ps1** (*Install or reinstall the SCCM Agent on a device*)
- **Install-WinSCP** (*Install or update WinSCP after verifying checksum*)
